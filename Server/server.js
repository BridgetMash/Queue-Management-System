...
app.post('/addpatient', async (req, res) => {
    ...
    try {
        ...
        const [rows] = await pool.query(`INSERT INTO queue (first_name, last_name, dob, address, phone_number, unique_number, position) VALUES (?, ?, ?, ?, ?, ?, ?)`, [first_name, last_name, dob, address, phone_number, unique_number, maxPos + 1]);
